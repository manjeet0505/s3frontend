...
export async function GET(request) {
  ...
  try {
    ...
    // GitHub may have null email — fetch emails list
    ...
    if (!email) {
      throw new Error('No email available from GitHub. Please make your email public or use a different login method.');
    }
    ...
    if (!user) {
      ...
      // Existing manual-signup user — link GitHub to their account
    ...
    // Short-lived readable cookie — for localStorage sync
